...
#   filename:  gnverifier_openapi.json.new
#   timestamp: 2025-02-26T18:53:11+00:00
...
class Version(BaseModel):
    version: str = Field(..., description='The version number.', examples=['v1.0.0'])
    build: str = Field(
        ...,
...
class Kingdom(BaseModel):
    name: str = Field(..., description="Kingdom's name.", examples=['Animalia'])
    names_num: int = Field(
        ...,
        alias='namesNum',
    ...
    percentage: float = Field(
        ..., description='The percentage of names matched the kingdom.', examples=[1]
    )
...
class SearchQuery(RootModel[str]):
    root: str = Field(
        ...,
...
class SearchMetadata(BaseModel):
    input: SearchInput
    names_number: int = Field(
        ..., alias='namesNumber', description='The number of found names.', examples=[2]
    )
