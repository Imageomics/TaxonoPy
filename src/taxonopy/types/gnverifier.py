...
#   timestamp: 2025-01-08T16:34:41+00:00
...
class Version(BaseModel):
    version: str = Field(..., description='The version number.', example='v1.0.0')
    build: str = Field(
        ..., description='The compilation timestamp.', example='2022-09-05_13:55:47UTC'
    )
...
class DataSource(BaseModel):
    ...
    title: str = Field(
        ..., description='The name of the data-source.', example='The Catalogue of Life'
    )
    ...
    doi: Optional[str] = Field(
        None, description='Digital Object Identifier', example='10.15468/rffz4x'
    )
    ...
    authors: Optional[str] = Field(
        None, description='Authors of the data-source.', example='F. Bisby et al'
    )
...
class VerificationInput(BaseModel):
    ...
    data_sources: Optional[List[int]] = Field(
        None, alias='dataSources', example=[1, 12, 170]
    )
...
class Kingdom(BaseModel):
    name: str = Field(..., description="Kingdom's name.", example='Animalia')
    names_num: int = Field(
        ...,
        alias='namesNum',
    ...
    percentage: float = Field(
        ..., description='The percentage of names matched the kingdom.', example=1
    )
...
class SearchInput(BaseModel):
    ...
    genus: Optional[str] = Field(
        None, description='Genus data, can be abbreviated.', example='Bubo'
    )
    species: Optional[str] = Field(
        None, description='Specific epithet, can be abbreviated.', example='bubo'
    )
    ...
    author: Optional[str] = Field(
        None, description="Author's name, can be abbreviated.", example='Linn.'
    )
    year: Optional[int] = Field(
        None, description="Name's year. Ignored if there is a `yearRange`.", example=0
    )
...
class SearchMetadata(BaseModel):
    input: SearchInput
    names_number: int = Field(
        ..., alias='namesNumber', description='The number of found names.', example=2
    )
...
class ResultData(BaseModel):
    ...
    data_source_title_short: str = Field(
        ...,
    ...
    score_details: ScoreDetails = Field(..., alias='scoreDetails')
